...
Same tool names and interface as ``genai_tk.agents.tools.sandbox_browser.tools`` so
...
from genai_tk.agents.tools.sandbox_browser.models import CredentialRef, PageSummary
