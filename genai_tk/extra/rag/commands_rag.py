...
def register_commands(cli_app: typer.Typer) -> None:
    ...
    Args:
        cli_app: Typer application instance to register commands with
    """
            ...
            if not configs:
                console.print(
                    create_warning_panel(
                        "No Configurations", "No vector store configurations found. Check your YAML configuration file."
                    )
                )
                return
    ...
    # Add the rag command group to the main CLI
