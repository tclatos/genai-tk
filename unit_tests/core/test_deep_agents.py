...
class TestDeepAgentConfig:
    ...
    def test_subagent_config(self):
        ...
        subagent = SubAgentConfig(name="test-subagent", description="Test subagent", prompt="You are a test subagent")
...
class TestDeepAgentFactory:
    ...
    def test_create_agent_basic(self, mock_get_llm, mock_create_deep_agent):
        ...
        # Create config
        config = DeepAgentConfig(name="Test Agent", instructions="Test instructions")
    ...
    def test_create_agent_async(self, mock_get_llm, mock_async_create_deep_agent):
        ...
        # Create config
        config = DeepAgentConfig(name="Async Agent", instructions="Async instructions")
    ...
    def test_list_agents(self):
        ...
        self.factory.agents = {"agent1": MagicMock(), "agent2": MagicMock(), "agent3": MagicMock()}
...
class TestSpecializedAgents:
    ...
    def test_create_research_agent(self, mock_get_llm, mock_create_deep_agent):
        ...
        agent = self.factory.create_research_agent(search_tool=search_tool, name="Test Research Agent")
    ...
    def test_create_coding_agent(self, mock_get_llm, mock_create_deep_agent):
        ...
        # Create coding agent
        agent = self.factory.create_coding_agent(name="Test Coding Agent", language="python")
    ...
    def test_create_data_analysis_agent(self, mock_get_llm, mock_create_deep_agent):
        ...
        agent = self.factory.create_data_analysis_agent(name="Test Analysis Agent")
...
class TestConvenienceFunctions:
    ...
    def test_create_coding_deep_agent(self, mock_factory):
        ...
        mock_factory.create_coding_agent.assert_called_once_with("Coder", "python", None, True)
...
class TestRunDeepAgent:
    ...
    async def test_run_deep_agent_basic(self):
        ...
        result = await run_deep_agent(agent=mock_agent, messages=messages, stream=False)
    ...
    async def test_run_deep_agent_with_files(self):
        ...
        result = await run_deep_agent(agent=mock_agent, messages=messages, files=files, stream=False)
